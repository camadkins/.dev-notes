...
aliases: []
# diagrams:
#  - binary_search_intervals.svg — shows shrinking [lo, hi) search range per iteration.
#  - binary_search_mid_overflow.svg — demonstrates safe midpoint calculation and interval updates.
---
