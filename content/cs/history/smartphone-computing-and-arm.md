...
The computer that reshaped daily life is the one in your pocket, and it runs on a different philosophy from the machines that came before. Where desktops chased raw speed, the smartphone made energy efficiency the goal, and the [[the-microprocessor|processor]] family that won that contest is ARM.
...
- [[the-microprocessor|The Microprocessor]], the lineage ARM belongs to
- [[ibm-system-360|The IBM System/360]], the instruction-set-as-contract idea ARM relies on
- [[moores-law|Moore's Law]], the scaling that powers these chips
- [[von-neumann-architecture|Von Neumann Architecture]], the model underneath
