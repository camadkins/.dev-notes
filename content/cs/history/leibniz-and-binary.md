...
Gottfried Leibniz did more than build a [[pascaline-and-stepped-reckoner|calculating machine]]. He worked out the number system that every computer would eventually run on, centuries before there was a computer to run it.
...
- [[boole-and-boolean-algebra|George Boole and the Algebra of Logic]], the two-valued logic that pairs with binary
- [[shannon-boolean-algebra-switching|Shannon's Master's Thesis]], where binary and logic met hardware
- [[pascaline-and-stepped-reckoner|Pascal, Leibniz, and Mechanizing Arithmetic]], Leibniz's other contribution
