...
A [[the-transistor|transistor]] is one switch. A useful computer needs millions of them, plus the wiring between them, and soldering those by hand does not scale. The integrated circuit solved that by building the whole circuit, components and connections together, on a single piece of silicon.
...
The early integrated circuit was expensive, too expensive for most buyers. What carried it through its infancy was military and space demand, the story told in [[minuteman-guidance-and-integrated-circuits|the Minuteman note]]. This note is the invention; that one is the economics that kept it alive until it got cheap.

## Related Notes

- [[the-transistor|The Transistor]], the component being integrated
- [[the-mosfet|The MOSFET]], the transistor that integrates best
- [[the-microprocessor|The Microprocessor]], a whole CPU as one integrated circuit
- [[minuteman-guidance-and-integrated-circuits|Minuteman Guidance and the Integrated Circuit]], the demand story
- [[semiconductor-supply-chains|Semiconductor Supply Chains]], the modern industry it became
