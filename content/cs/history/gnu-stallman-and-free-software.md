---
title: GNU, Stallman, and Free Software
description: How Richard Stallman set out to build a free operating system and invented copyleft, a license that uses copyright recursively to keep software free.
draft: false
comments: true
tags:
  - cs
...
The GNU Project produced the tools and utilities of an operating system but, for years, lacked a finished kernel. Combined with the Linux kernel, the GNU software forms a complete Unix-like system. This is the free and open-source world whose origins, in the culture of [[unix-and-open-source|Unix]], the open-source note describes.
