...
In 1937 a graduate student at MIT wrote what has often been called the most important master's thesis of the twentieth century. Claude Shannon, then twenty-one, showed that [[boole-and-boolean-algebra|Boole's]] algebra of logic was exactly the mathematics of electrical switches.
...
This is the earlier of Shannon's two world-changing ideas. The later one, [[shannon-and-information-theory|information theory]] in 1948, is a separate matter, treated in the military-computing cluster. Together they make Shannon one of the rare people with two foundational contributions to a field.

## Related Notes

- [[boole-and-boolean-algebra|George Boole and the Algebra of Logic]], the algebra Shannon put to work
- [[leibniz-and-binary|Leibniz and Binary]], the two-symbol system that matches two-state switches
- [[shannon-and-information-theory|Shannon and Information Theory]], his later, separate breakthrough
- [[von-neumann-architecture|Von Neumann Architecture]], the machines built from these circuits
