...
- [[ai-vs-ml-vs-dl|AI vs ML vs DL]] - the cornerstone: why the three are different kinds of claim, not a difficulty ladder.

### The paradigms

- [[supervised-learning|Supervised Learning]] - learning a function from labeled examples.
- [[unsupervised-learning|Unsupervised Learning]] - finding structure in data with no labels.
- [[generalization-vs-memorization|Generalization vs Memorization]] - why learning means performing on unseen data, not reciting the training set.
- [[features-and-representations|Features and Representations]] - how a problem is described, and the shift deep learning makes by learning the description itself.
...
The math these notes lean on lives in [[cs/statistics/index|Statistics]] (probability, regression, maximum likelihood, Bayes) and [[cs/math/index|Mathematics]] (linear algebra). The history of how machine learning went mainstream is in [[deep-learning-revolution|The Deep Learning Revolution]].
