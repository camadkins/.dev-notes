...
Parity is arithmetic, not magic. "Most parity data is calculated using XOR, but RAID 6 uses addition and multiplication in a particular Galois field or [[cs/military-computing/error-correcting-codes-military-comms|Reed-Solomon error correction]]."
