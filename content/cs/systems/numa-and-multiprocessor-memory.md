...
Two mitigations get named. Protocol-level: "cache coherency protocols such as the MESIF protocol attempt to reduce the communication required to maintain cache coherency." Structural: "Scalable Coherent Interface (SCI) is an IEEE standard defining a directory-based cache coherency protocol to avoid scalability limitations found in earlier multiprocessor systems," and "SCI is used as the basis for the NumaConnect technology."
