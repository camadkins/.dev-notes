...
- [[cs/systems/non-blocking-io-and-the-event-loop|Non-Blocking IO and the Event Loop]] - the `epoll`/`kqueue`/IOCP layer the completion your `await` resumes on actually comes from.
