...
One filter produces one feature map, a grid showing where that feature appears. A layer learns many filters in parallel, so it outputs a stack of feature maps. Early layers tend to learn edges and color blobs; deeper layers combine those into textures, parts, and eventually objects, exactly the layered [[features-and-representations|representation learning]] that defines deep learning in [[ai-vs-ml-vs-dl|AI vs ML vs DL]].
...
- [[features-and-representations|Features and Representations]], the layered features a CNN learns
- [[backpropagation|Backpropagation]] and [[gradient-descent|Gradient Descent]], how the filters are trained
- [[deep-learning-revolution|The Deep Learning Revolution]], AlexNet and the GPU turning point
- [[ai-vs-ml-vs-dl|AI vs ML vs DL]], why learned features are the deep learning claim
