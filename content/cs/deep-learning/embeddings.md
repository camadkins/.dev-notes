...
- [[features-and-representations|Features and Representations]], embeddings as the canonical learned representation
...
- [[gradient-descent|Gradient Descent]], how the vectors get trained
- [[loss-functions|Loss Functions]], the classification objective behind negative sampling
- [[linear-algebra-fundamentals|Linear Algebra Fundamentals]], dot products and cosine similarity as the comparison tools
- [[deep-learning-revolution|The Deep Learning Revolution]], the era that made learned representations the default
- [[ai-vs-ml-vs-dl|AI vs ML vs DL]], where representation learning sits in the bigger picture
