...
Influences:
- Introduced the **[[cs/pl/grammars-notation-bnfebnf|BNF grammar notation]]**, formalizing syntax description.
...
> [!note]
> “Object” in Simula meant an autonomous entity with internal state and communication channels, more than a data record.
...
**ML (MetaLanguage)**, developed in the 1970s for theorem proving, introduced **type inference** via the **[[cs/pl/hindleymilner-type-inference|Hindley–Milner]]** system.  
...
- "History of programming languages," Wikipedia. https://en.wikipedia.org/wiki/History_of_programming_languages . Supports the overall progression from early specialized/mechanical languages through high-level languages, and FORTRAN as the first commercially available high-level language developed in the mid-1950s.
- "Fortran," Wikipedia. https://en.wikipedia.org/wiki/Fortran . Supports FORTRAN being developed by IBM with a reference manual released in 1956, its design for numeric and scientific computation, and its status as an early compiled high-level language.
- "Lisp (programming language)," Wikipedia. https://en.wikipedia.org/wiki/Lisp_%28programming_language%29 . Supports LISP originating in the late 1950s, its fully parenthesized prefix notation, list processing roots, and its standing as the second-oldest high-level language still in common use after Fortran.