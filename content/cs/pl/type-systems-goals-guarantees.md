...
- "Type system," Wikipedia. https://en.wikipedia.org/wiki/Type_system . Supports type systems as formal methods that classify program phrases by the kinds of values they compute, acting as a static contract for safety, abstraction, documentation, and optimization, and the static-vs-dynamic and nominal-vs-structural distinctions.
- "Type safety," Wikipedia. https://en.wikipedia.org/wiki/Type_safety . Supports soundness as the guarantee that a well-typed program will not go wrong, decomposed into progress and preservation.
- "Curry–Howard correspondence," Wikipedia. https://en.wikipedia.org/wiki/Curry%E2%80%93Howard_correspondence . Supports the correspondence between types and propositions and between programs and proofs, including function types as implication and product types as conjunction.
