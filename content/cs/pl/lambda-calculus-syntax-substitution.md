...
> [!example]
> **Diagram idea** (`beta_reduction_trace.svg`): draw the reduction tree for Example 3 under normal-order vs CBV, marking where CBV would evaluate arguments first (still reaching the same normal form in this case).
