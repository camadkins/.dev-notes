---
title: DARPA and the Funding of AI
description: How the military's research money shaped the direction, the booms, and the busts of artificial intelligence.
draft: false
comments: true
tags:
  - cs
...
> [!note] The idea
> Research follows funding. AI's booms and winters, and the directions the field pursued, were driven substantially by DARPA's decisions about what to pay for.
...
The initiative backed concrete, ambitious projects. Among them were the Autonomous Land Vehicle, an early attempt at a self-driving vehicle, and the Dynamic Analysis and Replanning Tool, known as DART, used for military logistics planning. The mix is telling: a moonshot at machine autonomy alongside a practical tool that delivered real value.

## The scale

The money was substantial. By 1985 the initiative had spent 100 million dollars across 92 projects at 60 institutions, split between industry on one side and universities and government labs on the other. Over its full run, the Department of Defense spent a total of one billion dollars on it.
...
- "Strategic Computing Initiative," Wikipedia. https://en.wikipedia.org/wiki/Strategic_Computing_Initiative . Supports the initiative as a DARPA program directed by the Information Processing Technology Office, running from 1983 to 1993 and funding advanced computer hardware and artificial intelligence from chip design through AI software, the Autonomous Land Vehicle and the DART replanning tool as funded projects, the figure of 100 million dollars spent by 1985 across 92 projects at 60 institutions, and the total Department of Defense spend of one billion dollars.
