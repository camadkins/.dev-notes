...
ARPANET did not ask its host computers to handle routing. Between each host and the network sat a dedicated machine, the Interface Message Processor, that stored and forwarded packets. That machine, the subject of the [[cs/military-computing/imp-the-first-router|IMP]] note, is the ancestor of the router.

## Toward the internet

ARPANET was one network. Connecting it to others, packet radio and satellite networks, forced the invention of [[cs/military-computing/internetworking-prnet-satnet|gateways and TCP/IP]], and the [[cs/military-computing/dod-model-and-tcp-ip-standardization|standardization]] that followed turned a research network into the foundation of the internet.

## Related Notes

- [[cs/military-computing/paul-baran-and-packet-switching|Paul Baran and the Birth of Packet Switching]], the idea ARPANET realized
- [[cs/military-computing/imp-the-first-router|The IMP, the First Router]], the machine that ran the network
- [[cs/military-computing/internetworking-prnet-satnet|Cerf, Kahn, and the Internetworking Problem]], what came next
