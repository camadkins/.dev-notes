...
- [[shannon-and-information-theory|Shannon and Information Theory]], the framework this proof comes from
- [[venona-and-one-time-pad-reuse|VENONA and the Cost of Reusing a One-Time Pad]], the rule above broken in practice
- [[rsa-and-computational-hardness|RSA and Computational Hardness]], the practical alternative to perfect secrecy
- [[cryptography-codebreaking-and-the-nsa|Cryptography, Codebreaking, and the NSA]], the wider context
