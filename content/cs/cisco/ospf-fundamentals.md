...
**Exstart** is where the routers and their DR and BDR establish a primary-secondary relationship and choose the initial sequence number for adjacency formation, with the router with the higher router ID becoming the primary. Stuck here is the classic MTU mismatch.
