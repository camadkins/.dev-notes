...
Read the direction carefully. High to low is open by default; low to high is not, and is governed by the ACL you apply plus the implicit deny at the end of it. That asymmetry is the entire "inside can browse the internet, internet cannot browse inside" behavior, and it exists with an empty rule base.
