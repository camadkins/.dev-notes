...
The exhaustive version enumerates every possible resample instead of sampling them, which is only tractable for tiny data. There are $\binom{2n-1}{n}$ distinct resamples, giving 126 for $n = 5$, 92,378 for $n = 10$, and about $5.91 \times 10^{16}$ for $n = 30$.
